...
import { useGetCaseDetailsQuery, useUpdateServiceManagerStatusMutation } from "@/features/caseApiSlice";

export default function CaseDetailPageManager() {
    ...
    const [updateServiceStatus] = useUpdateServiceManagerStatusMutation();
    ...
    console.log("caseData.service_status", caseData?.serviceStatus)
    ...
    const handleApproval = async () => {
        try {
            ...
            await handleStatusUpdate("reopened");
        } catch (error) {
    ...
    return (
        <div className="max-w-4xl mx-auto p-4 md:p-8">
                ...
                <Box sx={{
                    ...
                    <Button
                        ...
                        onClick={() => {
                            ...
                            //   setServiceStatus("waitingtoStart");

                            // handleStatusUpdate("waitingtoStart");
                        }}
                        disabled={serviceStatus !== "waitingForApproval"}
                    >
                        Approve Service
                    </Button>
            ...
            <Dialog open={approvalDialog} onClose={() => setApprovalDialog(false)}>
                ...
                <DialogContent>
                    <Typography>Are you sure you want to approve this service?</Typography>
                    <Typography variant="body2" color="text.secondary" mt={1}>
                        This will change the status to "Waiting to Start" and notify the assigned employee.
                    </Typography>
                </DialogContent>
                <DialogActions>
                    ...
                    <Button onClick={handleApproval} color="primary" variant="contained">
                        Confirm Approval
                    </Button>
                </DialogActions>
            </Dialog>
