    ...
    try {
      ...
      if (res.success) {
        if (res.role === "manager") {
          ...
          setTimeout(() => {
            router.push(`/manager/${res.id}/dashboard`);
          }, 700);
        } else {
          setError(
            "This portal is for managers only. Please use the appropriate login."
          );
        }
      }
    } catch (err) {
      ...
      >
        ...
        <Box sx={{ position: "relative", zIndex: 1 }}>
          ...
          <Typography variant="h6" sx={{ mb: 4, opacity: 0.9 }}>
            Streamline your workforce with powerful management tools
          </Typography>
